...
import BrandsBody from '../../components/Tables/TableBody/BrandsBody';
import { Modal } from '../../components/ModalSettings';
import BrandsModal from '../../components/ModalBody/BrandsModal';
    ...
    <DefaultLayout>
      ...
      <div className="flex justify-end">
        <Link
          ...
          className="mb-4 inline-flex items-center justify-center gap-2.5 rounded-md bg-primary py-4 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10"
        >
          <span>
            <svg
      ...
      {isModalOpen && (
        ...
        >
          {(formProps: any) => (
            <BrandsModal {...formProps} categories={categories} />
          )}
        </Modal>
      )}
    </DefaultLayout>
